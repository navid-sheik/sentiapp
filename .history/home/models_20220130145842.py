...
class TweetRecord(models.Model):
    ...
    tweet_date =  models.DateTimeField("date_fetched")
    raw_text = models.CharField(max_length=10000)
    processed_text = models.CharField(max_length=10000)
    stemmed_text =  models.CharField(max_length=10000)
...
class HourlyRecord (models.Model):
    ...
    overall_stemmed_text =  models.CharField(max_length=10000)
    ...
    neutraul_count  =  models.IntegerField()
